...
class _ThemeModesExamplePageState extends State<ThemeModesExamplePage> {
              ...
              child: Row(
                ...
                children: <Widget>[
                  FloatingActionButton(
                    ...
                    child: Icon(_themeMode == ThemeMode.light ? Icons.wb_sunny : Icons.nightlight_round),
                  ),
                  FloatingActionButton(
  ...
  Widget _skeletonView() => SkeletonListView(
      ...
      item: SkeletonListTile(
        ...
        leadingStyle: SkeletonAvatarStyle(width: 64, height: 64, borderRadius: BorderRadius.circular(8)),

...
class ShimmerState extends State<ShimmerWidget> with SingleTickerProviderStateMixin {
  ...
  LinearGradient get gradient =>
      ((widget.themeMode ?? SkeletonTheme.of(context)?.themeMode ?? _appThemeMode) == ThemeMode.dark)
          ? _darkGradient
          : _lightGradient;

  LinearGradient get _lightGradient =>
      widget.shimmerGradient ?? SkeletonTheme.of(context)?.shimmerGradient ?? SHIMMER_GRADIENT;

  LinearGradient get _darkGradient =>
      widget.darkShimmerGradient ?? SkeletonTheme.of(context)?.darkShimmerGradient ?? DARK_SHIMMER_GRADIENT;
